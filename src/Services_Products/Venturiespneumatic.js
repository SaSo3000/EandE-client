...
import img from "../images/VENTURIES_PNEUMATIC VIBRATOR 2.jpg"
import logo from "../images/Screenshot 2023-06-20 082831.jpg";
const Venturiespneumatic = () => {
  function closeAll() {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>VENTURIES * PNEUMATIC VIBRATOR 2</h1>
      <img id='img4' src={img}/>
    </div>
...
export default Venturiespneumatic
