...
import img from "../images/Discription img2-3.jpg"
...
const Pr14 = () => {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>Faster & more competitively priced supply of Recommended/Consumable spares for any of above All Water Treatment Products</h1>
      <img id='img3' src={img}/>
    </div>
