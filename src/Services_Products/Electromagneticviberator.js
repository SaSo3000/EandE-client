...
import img from "../images/ELECTROMAGNETIC VIBRATOR.jpg"
import logo from "../images/Screenshot 2023-06-20 082831.jpg";
const Electromagneticviberator = () => {
  function closeAll() {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>ELECTROMAGNETIC VIBRATOR</h1>
      <img id='img4' src={img}/>
    </div>
...
export default Electromagneticviberator
