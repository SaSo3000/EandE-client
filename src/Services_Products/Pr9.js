...
import img from "../images/Discription img1-1.jpg"
...
const Pr10 = () => {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>Fabricate/Supply MDC, CYCLONE, BAG FILTER, SCRUBBER, ESP (Workshop & Site Fabrication Both) as per required GPCB Norms Fluegas Outlet</h1>
      <img id='img1' src={img}/>
    </div>
