...
import img from "../images/Discription img6(1).jpg"
...
const Pr6 = () => {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>Provide Services in Form of Annual Service Contract (ASC) & Emergency Breakdown Service, Faster & more competitively priced supply of Recommended/Consumable spares for any of above Heating Products</h1>
      <img id='img2' src={img}/>
    </div>
