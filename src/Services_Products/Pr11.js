...
import img from "../images/Discription img1-3.jpg"
...
const Pr12 = () => {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>Faster & more competitively priced supply of Recommended/Consumable spares for any of above Environment Products</h1>
      <img id='img2' src={img}/>
    </div>
