...
import img from "../images/OPACITY MONITOR FOR CONTINUOUS EMISSION MONITORING And Other ESP SPARES As Per Specific Design As Per Client Requirements.jpg"
...
const multi = () => {
  ...
  return (
    <div onMouseDown={closeAll}>    
      <div id='body'>
      <h1 id='h1'>OPACITY MONITOR FOR CONTINUOUS EMISSION MONITORING And Other ESP SPARES As Per Specific Design As Per Client Requirements</h1>
      <img id='img4' src={img}/>
    </div>
